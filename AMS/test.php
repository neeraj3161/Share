...
<head>
  ...
  <link rel="stylesheet" href="styleHome.css?<?=time()?>">
...
<div class="navbar">
  ...
  <a href="#news" class="nav-links"  onclick="document.getElementById('id01').style.display='block'" style="width:auto;">User login</a>
  <a href="#news" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Admin login</a>
  <a href="#news" class="nav-links"  onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Staff login</a>
...
<div id="id01" class="modal">
  ...
  <div id="id02" class="modal">
    ...
    <form class="modal-content animate" onsubmit="return verifyDataAdmin()" action="/AMS/staff/admin.php"  method="post" >
      <div class="imgcontainer">
